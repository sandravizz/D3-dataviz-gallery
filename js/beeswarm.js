...
const data7 = d3
  ...
  .then(function (data7) {
    ...
    let c = d3.scaleOrdinal().domain(sexe).range(["#022859", "#f20666"]);
    ...
    let y = d3.scaleBand().domain(edat).range([innerheight, 0]);

    let x = d3.scaleLinear().domain([0, 1300]).range([0, innerwidth]);
